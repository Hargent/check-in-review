...
function CarouselPrev({ children }: Props) {
  ...
  return (
    <IconButtonWrapper
      ...
      extendedClassNames=" disabled:opacity-0 absolute z-10 left-0 bottom-0 transform  xl:-translate-1/2 -translate-0 hover:bg-[var(--tertiary-theme)] bg-[var(--tertiary-theme)] p-2 rounded-[50%] md:bg-transparent"
      onClick={prev}
    >
      {children}
    </IconButtonWrapper>
